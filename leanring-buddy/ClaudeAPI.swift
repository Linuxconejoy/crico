...
class ClaudeAPI {
    ...
    private let workerAppKey: String?
    var model: String
    private let session: URLSession

    init(proxyURL: String, model: String = "claude-sonnet-4-6", workerAppKey: String? = nil) {
        self.apiURL = URL(string: proxyURL)!
        self.workerAppKey = workerAppKey?.trimmingCharacters(in: .whitespacesAndNewlines)
        self.model = model
    ...
    private func makeAPIRequest() -> URLRequest {
        ...
        if let workerAppKey, !workerAppKey.isEmpty {
